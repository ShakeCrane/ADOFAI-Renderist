...
namespace ADOFAI.Renderist.Export
{
    ...
    internal static class OutputGeometryPolicy
    {
        ...
        ///   * 每相邻两级的比例 ≤ 2:1。**注意**：只有比例恰为 2:1 的级，其逐级 bilinear
        ///     采样才近似 2×2 box 平均；`3W→2W`（1.5:1，如 scale=3/5/6 的首级）**不是**
        ///     box 平均。因此本算法命名为 `multi-stage-bilinear`，**不得**普遍等价为
        ///     box filtering / box downsample。
